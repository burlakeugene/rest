...
/* harmony import */ var _js_cart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/cart */ "./src/js/cart.js");
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function commonFunc() {
      ...
      products.length && products.forEach(function (product) {
        product.addEventListener('click', function (event) {
          var dataset = product.dataset;
          product.disabled = true;
          _js_cart__WEBPACK_IMPORTED_MODULE_6__["add"](dataset).finally(function () {
      ...
      slideBar && slideBar.addEventListener('click', function (e) {
        e.stopPropagation();
      });
...
/*!************************!*\
  !*** ./src/js/cart.js ***!
  \************************/
/*! exports provided: update, add, clear */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  _createClass(Search, [{
    ...
    value: function init() {
      ...
      this.button.addEventListener('click', function (event) {
        event.stopPropagation();
        var nextState = !_this2.button.classList.contains(activeClass);
        nextState ? _this2.showPanel() : _this2.hidePanel();
      });
    }
  }]);
