...
/* harmony import */ var _js_request__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/request */ "./src/js/request.js");
    ...
    function commonFunc() {
      ...
      products.length && products.forEach(product => {
        product.addEventListener('click', event => {
          ...
          _js_cart__WEBPACK_IMPORTED_MODULE_7__["add"]({
            product_id: +id
          });
        });
      });
...
const request = new burlak__WEBPACK_IMPORTED_MODULE_0__["Request"]();
